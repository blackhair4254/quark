    ...
    <div class="tabs-wrap">
      <div class="tabs-scroll">
        @foreach($statuses as $s)
          ...
          <a href="{{ route('wms.balance_stock.index',['status'=>$s]) }}"
        ...
        <table class="table">
          ...
          @forelse($list as $h)
            <tr>
              ...
              <td>{{ $h->approver?->nama_pengguna ?? '-' }}</td>
              <td>
                <a class="btn-sm" href="{{ route('wms.balance_stock.show',$h) }}">Detail</a>
              </td>
            </tr>
          @empty
            <tr>

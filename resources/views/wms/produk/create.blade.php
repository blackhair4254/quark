...
<div class="dash-layout">
  <aside class="dash-sidebar">
    ...
    <nav class="dash-menu">
      ...
      <a class="menu-item active" href="{{ url('/wms/produk') }}">Produk</a>
  ...
  <main class="dash-main">
    ...
    <form action="{{ route('wms.produk.store') }}" method="POST" enctype="multipart/form-data" class="card form-grid">
      @csrf
      <label>Nama Produk* <input type="text" name="nama_produk" value="{{ old('nama_produk') }}" required></label>
      <label>SKU <input type="text" name="sku" value="{{ old('sku') }}"></label>
      <label>Category* <input type="text" name="category" value="{{ old('category') }}" required></label>
      <label>Deskripsi* <textarea name="deskripsi" rows="4" required>{{ old('deskripsi') }}</textarea></label>
      <label>Berat* (gram) <input type="number" step="1" min="0" name="berat" value="{{ old('berat') }}" required></label>
      <label>Harga Beli* <input type="number" step="0.01" min="0" name="harga_beli" value="{{ old('harga_beli') }}" required></label>
      <label>Harga Jual* <input type="number" step="0.01" min="0" name="harga_jual" value="{{ old('harga_jual') }}" required></label>
